...
object ApiModule {
    ...
    private fun getHeadersBuilder(chain: Interceptor.Chain): Request.Builder {
        return chain
            ...
            .addHeader(AUTHORIZATION_HEADER, provideClientAuthorizationHeader())
    }

    private fun provideClientAuthorizationHeader(): String {
        val encodeToString = Base64.encodeToString(
            "${BuildConfig.API_KEY_ID}:${BuildConfig.API_KEY_SECRET}".toByteArray(),
            Base64.NO_WRAP
        )
